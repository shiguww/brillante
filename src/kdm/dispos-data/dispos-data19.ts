...
class DisposData19 extends KDMStructure<IDisposData19> {
  ...
  public override get(): IDisposData19 {
  ...
  public override set(data: unknown): this {
    const disposdata = IDisposData19.parse(data);
