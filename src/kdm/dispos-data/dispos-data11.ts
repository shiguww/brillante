...
class DisposData11 extends KDMStructure<IDisposData11> {
  ...
  public override set(data: unknown): this {
    const disposdata = IDisposData11.parse(data);
