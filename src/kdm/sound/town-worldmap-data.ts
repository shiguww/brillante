...
const ITownWorldMapData = z.object({
  _kind: z.literal("TownWorldMapData").default("TownWorldMapData"),
...
class TownWorldMapData extends KDMStruct<ITownWorldMapData> {
  ...
  protected override _get(): ITownWorldMapData {
  ...
  protected override _set(townworldmapdata: ITownWorldMapData): void {
